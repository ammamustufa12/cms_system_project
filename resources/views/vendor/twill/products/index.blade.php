                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin_assets/images/logo-sm.png') }}" alt=""
                                        height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin_assets/images/logo-dark.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('admin_assets/images/logo-light.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button"
                                ...
                                <img id="header-lang-img" src="{{ asset('admin_assets/images/flags/us.svg') }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/us.svg') }}" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/spain.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/germany.svg') }}" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/italy.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/russia.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/china.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/french.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin_assets/images/flags/ae.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18">
...
@endauth
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                             ...
                             <form method="POST" action="{{ route('twill.logout') }}" id="logout-form">
    @csrf
    <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        ...
        <div class="app-menu navbar-menu">
           ...
           <li class="menu-title"><span>Main Navigation</span></li>
...
<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/notifications">
        <i class="ri-notification-3-line"></i> <span>Notifications</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/quick-actions">
        <i class="ri-flashlight-line"></i> <span>Quick Actions</span>
    </a>
</li>
...
<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/blogs">
...
<li class="nav-item">
    <a class="nav-link menu-link" href="{{ route('products.index') }}">
        <i class="ri-image-line"></i> <span>products</span>
    </a>
</li>
{{-- <li class="nav-item">
    ...
    <div class="collapse menu-dropdown" id="sidebarEcommerce">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/brands">🏷️ Brands</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/attributes">🔖 Attributes</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/wishlist-groups">💖 Wishlist Groups</a>
            </li>
            <li class="nav-item">
...
<style>
.navbar-nav .nav-item .collapse .nav-link {
    display: block;
    padding: 8px 20px;
    white-space: nowrap;
}
...
<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/import-export">
        <i class="ri-upload-cloud-line"></i> <span>Import/Export</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/content-types">
        <i class="ri-layout-3-line"></i> <span>Content Types</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/fields-manager">
        <i class="ri-settings-3-line"></i> <span>Field Manager</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/page-builder">
        <i class="ri-magic-line"></i> <span>Page Builder</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/email-designer">
        <i class="ri-mail-line"></i> <span>Email Designer</span>
    </a>
</li>

<li class="menu-title"><span>Users & Permissions</span></li>
...
<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/site-settings">
        <i class="ri-settings-line"></i> <span>Site Settings</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/system-logs">
        <i class="ri-file-search-line"></i> <span>System Logs</span>
    </a>
</li>

<li class="nav-item">
    <a class="nav-link menu-link" href="/admin/cache-clear">
        <i class="ri-refresh-line"></i> <span>Clear Cache</span>
    </a>
</li>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('admin_assets/images/users/avatar-1.jpg') }}"
                                                                                alt=""
    ...
    @if (config('twill.enabled.users-management'))
        <form style="display: none" method="POST"
            action="{{ route(config('twill.admin_route_name_prefix') . 'logout') }}" data-logout-form>
            @csrf
        </form>
    @endif
