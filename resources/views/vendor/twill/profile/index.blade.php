                ...
                <div class="container-fluid">
                    <div class="profile-foreground position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg">
                            <img src="{{ asset('admin_assets/images/profile-bg.jpg')}}" alt="" class="profile-wid-img" />
                        </div>
                    </div>
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ asset('admin_assets/images/users/avatar-1.jpg')}}" alt="user-img"
                            ...
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1">{{ $user->name ?? 'Unknown' }}</h3>
                                    <p class="text-white text-opacity-75">{{ $user->designation ?? 'No designation' }}</p>
                                    <div class="hstack text-white-50 gap-1">
                                        <div class="me-2"><i
                                                class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $user->city ?? 'City' }}, {{ $user->country ?? 'Country' }}</div>
                                        <div>
                                            <i
                                                class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i> {{ $user->website ?? 'No website' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <table class="table table-borderless mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted">{{ $user->location ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <th class="ps-0" scope="row">Joining Date</th>
                        <td class="text-muted">{{ $user->joining_date ? \Carbon\Carbon::parse($user->joining_date)->format('d M Y') : 'N/A' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
  ...
  <div class="card-body">
    ...
    <div class="d-flex flex-wrap gap-2">
      @if($user->github_username)
        <div>
          <a href="https://github.com/{{ ltrim($user->github_username, '@') }}" target="_blank" class="avatar-xs d-block" title="GitHub">
      ...
      @if($user->portfolio_website)
        <div>
          <a href="{{ $user->portfolio_website }}" target="_blank" class="avatar-xs d-block" title="Website">
      ...
      @if($user->dribbble_username)
        <div>
          <a href="https://dribbble.com/{{ ltrim($user->dribbble_username, '@') }}" target="_blank" class="avatar-xs d-block" title="Dribbble">
      ...
      @if($user->pinterest_username)
        <div>
          <a href="https://pinterest.com/{{ ltrim($user->pinterest_username, '@') }}" target="_blank" class="avatar-xs d-block" title="Pinterest">
      ...
      @endif
                ...
                @foreach($user->skills as $skill)
                                                            <a href="javascript:void(0);"
                                                                class="badge bg-primary-subtle text-primary">{{ $skills }}</a>
     @endforeach
            @else
...
<div class="card">
    <div class="card-body">
        ...
        <p>{!! nl2br(e($user->description ?? 'No description provided.')) !!}</p>
        <div class="row">
            <div class="col-6 col-md-4">
                <div class="d-flex mt-4">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        ...
                        <h6 class="text-truncate mb-0">{{ $user->designation ?? 'N/A' }}</h6>
                    </div>
                </div>
            </div>
            <!--end col-->
            <div class="col-6 col-md-4">
                <div class="d-flex mt-4">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        ...
                        @if ($user->website)
                            <a href="{{ $user->website }}" class="fw-semibold" target="_blank" rel="noopener">
                                {{ $user->website }}
                            </a>
                        @else
                                                                                    ...
                                                                                    <div class="accordion-header"
                                                                                        ...
                                                                                        <a class="accordion-button p-2 shadow-none"
                                                                                            ...
                                                                                            <div class="d-flex">
                                                                                                <div
                                                                                                    class="flex-shrink-0">
                                                                                                    <img src="{{ asset('admin_assets/images/users/avatar-7.jpg')}}"
                                                                                                        alt=""
                                                                                                        class="avatar-xs rounded-circle material-shadow" />
                                                                                                </div>
                                                                                                <div
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xxl-4">
                                                                    <div class="row border border-dashed gx-2 p-2 mb-2">
                                                                        <div class="col-4">
                                                                            <img src="{{ asset('admin_assets/images/small/img-2.jpg')}}"
                                                                                alt=""
                                                                                class="img-fluid rounded material-shadow" />
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-4">
                                                                            <img src="{{ asset('admin_assets/images/small/img-3.jpg')}}"
                                                                                alt=""
                                                                                class="img-fluid rounded material-shadow" />
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-4">
                                                                            <img src="{{ asset('admin_assets/images/small/img-4.jpg')}}"
                                                                                alt=""
                                                                                class="img-fluid rounded material-shadow" />
                                                                        </div>
                                                                        <!--end col-->
