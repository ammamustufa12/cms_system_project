                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">PermissionManagement</li>
                            </ol>
                        </div>
    ...
    <tbody class="list form-check-all">
        @foreach ($permissions as $permission)
            <tr>
                <th scope="row">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="chk_permission"
                            value="{{ $permission->id }}">
                    </div>
                </th>
                <td class="name">{{ $permission->name }}</td>
                <td class="slug">{{ $permission->slug }}</td>
                <td class="description">{{ $permission->description ?? '-' }}</td>
                <td class="created_at">{{ $permission->created_at->format('d M, Y') }}</td>
                <td>
                    <div class="d-flex gap-2">
                        <div class="edit">
                            <button class="btn btn-sm btn-success edit-permission-btn"
                                data-bs-toggle="modal" data-bs-target="#editPermissionModal"
                                data-id="{{ $permission->id }}">Edit</button>
                        </div>
                        <div class="remove">
                            <button class="btn btn-sm btn-danger delete-permission-btn"
