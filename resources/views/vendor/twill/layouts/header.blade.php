                     ...
                     <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                         <div data-simplebar style="max-height: 320px;">
                             ...
                             <div class="notification-list">
                                 ...
                                 <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                     <div class="d-flex">
                                         <img src="{{ asset('admin_assets/images/users/avatar-5.jpg') }}"
                                             class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                         <div class="flex-grow-1">
...
<div class="dropdown topbar-head-dropdown ms-1 header-item">
    <button type="button" 
        ...
        id="switch-template-dropdown" 
        data-bs-toggle="dropdown" 
        aria-haspopup="true" 
        aria-expanded="false">
        <span>Switch Template</span>
        <i class='bx bx-chevron-down fs-16 ms-1'></i>
    </button>
    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="switch-template-dropdown">
        <a class="dropdown-item" href="{{ route('config.index') }}">
            <i class='bx bx-cog fs-16 me-2'></i>
            <span>Config</span>
        </a>
        <a class="dropdown-item" href="{{ route('setup.index') }}">
            <i class='ri-profile-line fs-16 me-2'></i>
            <span>Setup Area</span>
        </a>
        <a class="dropdown-item" href="{{ route('active-area.index') }}">
            <i class='ri-home-3-line fs-16 me-2'></i>
            <span>Active Area</span>
                         ...
                         <div data-simplebar style="max-height: 300px;">
                             <div class="p-2">
                                 ...
                                 <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                     <div class="d-flex align-items-center">
                                         <img src="{{ asset('admin_assets/images/products/img-1.png') }}"
                                 ...
                                 <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                     <div class="d-flex align-items-center">
                                         <img src="{{ asset('admin_assets/images/products/img-3.png') }}"
                                             class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                         <div class="flex-grow-1">
                                             <h6 class="mt-0 mb-1 fs-14">
                                 ...
                                 <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                     <div class="d-flex align-items-center">
                                         <img src="{{ asset('admin_assets/images/products/img-6.png') }}"
                                             class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                         <div class="flex-grow-1">
                                             <h6 class="mt-0 mb-1 fs-14">
                                 ...
                                 <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                     <div class="d-flex align-items-center">
                                         <img src="{{ asset('admin_assets/images/products/img-5.png') }}"
                                             class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                         <div class="flex-grow-1">
                                             <h6 class="mt-0 mb-1 fs-14">
                                                 <a href="apps-ecommerce-product-details.html"
                         ...
                         <div class="tab-content position-relative" id="notificationItemsTabContent">
                             <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                 <div data-simplebar style="max-height: 300px;" class="pe-2">
                                     ...
                                     <div class="text-reset notification-item d-block dropdown-item position-relative">
                                         <div class="d-flex">
                                             <img src="{{ asset('admin_assets/images/users/avatar-8.jpg') }}"
                                                 class="me-3 rounded-circle avatar-xs flex-shrink-0" alt="user-pic">
                                             <div class="flex-grow-1">
                                                 <a href="#!" class="stretched-link">
                             ...
                             <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                 ...
                                 <div data-simplebar style="max-height: 300px;" class="pe-2">
                                     ...
                                     <div class="text-reset notification-item d-block dropdown-item">
                                         <div class="d-flex">
                                             <img src="{{ asset('admin_assets/images/users/avatar-6.jpg') }}"
                                                 class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                             <div class="flex-grow-1">
                                                 <a href="#!" class="stretched-link">
                 ...
                 <div class="dropdown ms-sm-3 header-item topbar-user">
                     ...
                     <div class="dropdown-menu dropdown-menu-end">
                         ...
                         {{-- <a class="dropdown-item" href="{{ route('profile_settings.index') }}">
    <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
    <span class="align-middle">Profile</span>
</a> --}}

                         <!-- This one is correct for settings -->
                         <a class="dropdown-item" href="{{ route('profile_settings.index') }}">
 ...
 document.addEventListener('DOMContentLoaded', function() {
     ...
     if (hamburgerBtn) {
         console.log('Hamburger button found, adding event listener...');
 ...
 function toggleSidebar() {
     ...
     if (currentSize === 'sm') {
         ...
         console.log('Sidebar expanded to lg (260px)');
         ...
         console.log('Sidebar collapsed to sm (70px)');
     ...
     localStorage.setItem('sidebar-size', html.getAttribute('data-sidebar-size'));
     
     // Dispatch custom event for other scripts
     const event = new CustomEvent('sidebarToggle', {
         detail: { size: html.getAttribute('data-sidebar-size') }
     });
 ...
 function restoreSidebarState() {
     ...
     if (savedSize) {
         ...
         console.log('Sidebar state restored to:', savedSize);
     }
 }
 
 // Initialize sidebar state when page loads
 window.addEventListener('load', function() {
     console.log('Page loaded, restoring sidebar state...');
     restoreSidebarState();
 });
 
 // Add keyboard shortcut (Ctrl + B) for sidebar toggle
 ...
 console.log('Sidebar JavaScript loaded successfully');
   ...
   [data-sidebar-size="sm"] .navbar-menu .navbar-nav .menu-title,
   [data-sidebar-size="sm"] .navbar-menu .navbar-brand-box .logo-lg {
       display: none !important;
   }
   
   [data-sidebar-size="sm"] .navbar-menu .navbar-brand-box .logo-sm {
   ...
   [data-sidebar-size="lg"] .navbar-menu {
   ...
   [data-sidebar-size="lg"] .navbar-menu .navbar-nav .nav-link span,
   [data-sidebar-size="lg"] .navbar-menu .navbar-nav .menu-title,
   [data-sidebar-size="lg"] .navbar-menu .navbar-brand-box .logo-lg {
       display: block !important;
   }
   
   [data-sidebar-size="lg"] .navbar-menu .navbar-brand-box .logo-sm {
       display: none !important;
   }
   
   [data-sidebar-size="lg"] .main-content {
   ...
   /* Debug styles - make sidebar changes more visible */
   .navbar-menu {
   ...
   * {
       transition: width 0.3s ease, min-width 0.3s ease, max-width 0.3s ease, margin-left 0.3s ease !important;
   }
   </style>
