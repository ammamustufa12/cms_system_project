...
<form action="{{ route('profile.socialmedia_store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="flex-shrink-0">
<button type="submit" class="badge bg-light text-primary fs-12 border-0">
    <i class="ri-add-fill align-bottom me-1"></i> Add
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <input type="text" name="github_username" class="form-control" id="gitUsername" placeholder="Username"
                                    value="@daveadame">
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="avatar-xs d-block flex-shrink-0 me-3">
                                ...
                                <input type="text" name="websiteInput" class="form-control" id="websiteInput" placeholder="www.example.com"
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <input  type="text" name="dribbble_username" class="form-control" id="dribbleName" placeholder="Username"
                                    value="@dave_adame">
                            </div>
                            <div class="d-flex">
                                <div class="avatar-xs d-block flex-shrink-0 me-3">
                                ...
                                <input type="text" name="pinterest_username" class="form-control" id="pinterestName" placeholder="Username"
                                    value="Advance Dave">
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="firstname" class="form-control"
                                                        ...
                                                        value="{{ old('firstnameInput', $user->first_name ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="lastname" class="form-control"
                                                        ...
                                                        value="{{ old('lastnameInput', $user->last_name ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="phonenumber" class="form-control"
                                                        ...
                                                        value="{{ old('phonenumberInput', $user->phone ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="email" class="form-control"
                                                        ...
                                                        value="{{ old('emailInput', $user->email ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    {{-- <input type="text" name="Joiningdat" class="form-control"
                                                        data-provider="flatpickr" id="JoiningdatInput"
                                                        data-date-format="d M, Y"
                                                        data-deafult-date="{{ old('JoiningdatInput', optional($user->joining_date)->format('d M, Y')) }}"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="skills[]" class="form-control" data-choices
                                                        data-choices-text-unique-true multiple id="skillsInput">
                                                        <option value="illustrator"
                                                            {{ in_array('illustrator', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            Illustrator</option>
                                                        <option value="photoshop"
                                                            {{ in_array('photoshop', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            Photoshop</option>
                                                        <option value="css"
                                                            {{ in_array('css', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            CSS</option>
                                                        <option value="html"
                                                            {{ in_array('html', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            HTML</option>
                                                        <option value="javascript"
                                                            {{ in_array('javascript', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            Javascript</option>
                                                        <option value="python"
                                                            {{ in_array('python', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            Python</option>
                                                        <option value="php"
                                                            {{ in_array('php', old('skillsInput', $user->skills ?? [])) ? 'selected' : '' }}>
                                                            PHP</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="designationInput" class="form-control"
                                                        id="designationInput" placeholder="Designation"
                                                        value="{{ old('designationInput', $user->designation ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="websiteInput1" class="form-control"
                                                        id="websiteInput1" placeholder="www.example.com"
                                                        value="{{ old('websiteInput1', $user->website ?? '') }}" />
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="countryInput" class="form-control"
                                                        id="countryInput" placeholder="Country"
                                                        value="{{ old('countryInput', $user->country ?? '') }}" />
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="zipcodeInput" class="form-control"
                                                        minlength="5" maxlength="6" id="zipcodeInput"
                                                        placeholder="Enter zipcode"
                                                        value="{{ old('zipcodeInput', $user->zipcode ?? '') }}">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-12">
                                                <div class="mb-3 pb-2">
                                                    ...
                                                    <textarea name="exampleFormControlTextarea" class="form-control" id="exampleFormControlTextarea"
                                                        placeholder="Enter your description" rows="3">{{ old('exampleFormControlTextarea', $user->description ?? '') }}</textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-12">
