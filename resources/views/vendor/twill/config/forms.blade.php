                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Forms Settings</h5>
                        </div>
                        <div class="card-body">
                            <p>Configure forms settings here.</p>
                            
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Form Validation</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="button" class="btn btn-primary">Save Forms</button>
                                </div>
                            </div>
                        </div>
                    </div>
