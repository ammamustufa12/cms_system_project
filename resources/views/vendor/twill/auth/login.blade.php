                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{ url('/') }}" class="d-inline-block auth-logo">
                                    <img src="{{ asset('admin_assets/images/logo-light.png') }}" alt="Logo" height="20">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Welcome to Your Admin Panel</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('twill.login') }}">
                                        @csrf
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <div>
                                                {{-- Add your social login buttons or remove these if not used --}}
                        ...
                        <div class="mt-4 text-center">
                            {{-- <p class="mb-0">Don't have an account? <a href="{{ route('twill.register') }}" class="fw-semibold text-primary text-decoration-underline"> Signup </a></p> --}}
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Your Company. Crafted with <i class="mdi mdi-heart text-danger"></i></p>
                        </div>
                    </div>
                </div>
            </div>
