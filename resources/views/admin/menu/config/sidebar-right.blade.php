...
<div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 80px;padding-left:30px;">
    <div>
        <h2 class="mb-0">MENU LINKS - <span id="currentMenuType">Sidebar Right</span></h2>
...
<div class="menu-management-container">
    ...
    <div class="left-panel">
        <div class="menu-links-list" id="menu-links-list">
            <!-- Recent Activity Right Sidebar Item -->
            <div class="menu-item" draggable="true" data-id="1">
                <span class="drag-handle">⋮⋮</span>
                <input type="checkbox" checked>
                <input type="text" value="Recent Activity" class="menu-name">
            ...
            <!-- Quick Links Right Sidebar Item -->
            ...
            <div class="sub-menu">
                <div class="menu-item" draggable="true" data-id="2-1">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Bookmarks" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
                ...
                <div class="menu-item" draggable="true" data-id="2-2">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Favorites" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
                ...
                <div class="menu-item" draggable="true" data-id="2-3">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Shortcuts" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
            ...
            <!-- Notifications Right Sidebar Item -->
            <div class="menu-item" draggable="true" data-id="3">
                <span class="drag-handle">⋮⋮</span>
                <input type="checkbox" checked>
                <input type="text" value="Notifications" class="menu-name">
                <div class="toggle-switch active" onclick="toggleSwitch(this)"></div>
                <div class="actions">
                    <button title="Add">+</button>
                    <button title="Edit">✏️</button>
            ...
            <!-- Widgets Right Sidebar Item -->
            <div class="menu-item" draggable="true" data-id="4">
                <span class="drag-handle">⋮⋮</span>
                <input type="checkbox" checked>
                <input type="text" value="Widgets" class="menu-name">
                <div class="toggle-switch active" onclick="toggleSwitch(this)"></div>
                <div class="actions">
                    <button title="Add">+</button>
                    <button title="Edit">✏️</button>
            ...
            <div class="sub-menu">
                <div class="menu-item" draggable="true" data-id="5-1">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Calculator" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
                ...
                <div class="menu-item" draggable="true" data-id="5-2">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Converter" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
                ...
                <div class="menu-item" draggable="true" data-id="5-3">
                    <span class="drag-handle">⋮⋮</span>
                    <input type="checkbox" checked>
                    <input type="text" value="Notes" class="menu-name">
                    <div class="actions">
                        <button title="Add">+</button>
                        <button title="Edit">✏️</button>
                    </div>
