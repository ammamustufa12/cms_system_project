            ...
            <div class="card-body bg-primary p-4 p-xl-5">
              ...
              <form action="/user/signup" method="post" enctype="multipart/form-data" id="signup-form">
                ...
                <!--
									...
									<div class="mb-3 input-group">
										<span class="input-group-text bg-body"> <i class="la la-user"></i> </span>
    ...
    <div class="row gy-5 gy-md-6 gy-lg-0">
      <div class="col-6 col-lg-3">
        <div class="text-center">
          ...
          <h5 class="display-6 fw-bold m-1">180K</h5>
      ...
      <div class="col-6 col-lg-3">
        <div class="text-center">
          ...
          <h5 class="display-6 fw-bold m-1">350K</h5>
      ...
      <div class="col-6 col-lg-3">
        <div class="text-center">
          ...
          <h5 class="display-6 fw-bold m-1">82+</h5>
...
Vvveb.Sections.add("portfolio/portfolio-1", {
  ...
  <div class="gallery masonry" data-component-gallery="portfolio-1">
    <div class="item" data-aos="fade-up">
      <a href="demo/img/team-1.jpg">
        <img class="img-fluid" src="demo/img/team-1.jpg">
      </a>
    </div>
    <div class="item" data-aos="fade-up" data-aos-delay="100">
      <a href="demo/img/team-2.jpg">
        <img class="img-fluid" src="demo/img/team-2.jpg">
      </a>
    </div>
  ...
  <div class="container">
    ...
    <div class="gallery masonry has-shadow" data-component-gallery="portfolio-3" style="column-count: 2;">
      <div class="item" data-aos="fade-up">
        <a href="demo/img/team-1.jpg">
          <img class="img-fluid" src="demo/img/team-1.jpg">
        </a>
